...
- `fonts`：界面字体、等宽字体与字号角色；`editorDefaultFamily`、
  `editorDefaultFallbackFamily`、`editorDefaultSize`、`editorDefaultWeight` 是 `settings.ini`
  编辑区字体设置的默认值来源。
